...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030308] overflow-x-hidden">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-40 bg-[#030308]/95 backdrop-blur-xl md:hidden"
          >
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-[100dvh] flex items-center justify-center pt-16 sm:pt-[72px]">
        {/* Background */}
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            style={{ x: smoothX, y: smoothY }}
            className="absolute top-[15%] left-1/2 -translate-x-1/2 h-[400px] w-[400px] sm:h-[600px] sm:w-[800px] rounded-full bg-brand-500/[0.07] blur-[120px] sm:blur-[180px]"
          />
        ...
        <motion.div
          ...
          className="relative z-10 mx-auto max-w-5xl px-5 sm:px-6 text-center"
        >
          {/* Badge */}
          <motion.div
            ...
            className="mb-8 sm:mb-10 inline-flex items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.02] px-3 py-1.5 sm:px-4 sm:py-2 backdrop-blur-sm"
          >
          ...
          <motion.p
            ...
            className="mt-5 sm:mt-7 mx-auto max-w-xl text-sm sm:text-base lg:text-lg text-zinc-500 leading-relaxed px-2"
          >
          ...
          <motion.div
            ...
            className="mt-10 sm:mt-14 flex flex-wrap items-center justify-center gap-x-5 sm:gap-x-8 gap-y-2"
          >
            {[
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="group relative p-5 sm:p-7 rounded-2xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-500"
              >
                ...
                <div className="relative">
                  <div className="mb-4 sm:mb-5 inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.06] group-hover:border-brand-500/20 group-hover:bg-brand-500/[0.05] transition-all duration-500">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-0 sm:divide-x sm:divide-white/[0.04]">
            {[
              ...
              <motion.div
                ...
                className="text-center px-2 sm:px-8 py-4 sm:py-6"
              >
